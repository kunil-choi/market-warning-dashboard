...
def collect_rates_data() -> Dict[str, Any]:
    try:
        ...
        def prev(name, n=22, fallback=None):
            s = rate_data.get(name)
        ...
        t10y_3m_ago = prev("t10y", 66)
        fed_3m_ago  = prev("fed_funds", 66)

        yield_curve      = t10y_now - t2y_now
        vigilante_spread = t10y_now - fed_now
        vigilante_triggered = (fed_now < fed_3m_ago) and (t10y_now > t10y_3m_ago)
